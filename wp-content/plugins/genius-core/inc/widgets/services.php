                            ...
                            <div class="col-lg-4 col-md-6 mb-2">
                                <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                        ...
                                        <?php if($settings['genius_image']['url']) { ?><i class="fa fa-2x <?php echo $settings['genius_card_icon'] ?> text-secondary"></i><?php } ?>
                                        </div>
                                        <h1 class="display-2 text-white mt-n2 m-0"><?php echo esc_html($counter) ?></h1>
                                    </div>
                                    <h4 class="text-uppercase mb-3"><?php echo esc_html($settings['genius_title']) ?></h4>
                                    <p class="m-0"><?php echo esc_html($settings['genius_description']) ?></p>
                                </div>
                            </div>
