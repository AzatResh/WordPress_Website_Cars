...
$opt_name = 'genius_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'genius' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'genius' ),
...
Redux::set_section(
	...
	array(
		...
		'subsection'	   => true,
		'desc'             => esc_html__( 'Settings for Header', 'redux-framework-demo' ),
		...
		'fields'		   => array(
			array(
				'id'               => 'phone',
				'type'			   => 'text',
				'title'            => esc_html__( 'Phone number', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert Phone', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Phone', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'header_img',
			...
			array(
				...
				'subtitle'		   => esc_html__( 'Insert Email', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Email', 'redux-framework-demo' ),
				'default' 		   => ""
			),
		)
	)
	...
	array(
		...
		'fields'		   => array(
			array(
				'id'               => 'fb',
				'type'			   => 'text',
				'title'            => esc_html__( 'FB link', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert profile link', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Social link', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'twi',
				'type'			   => 'text',
				'title'            => esc_html__( 'Twitter link', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert profile link', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Social link', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'in',
				'type'			   => 'text',
				'title'            => esc_html__( 'LinkedIn link', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert profile link', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Social link', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'ins',
				'type'			   => 'text',
				'title'            => esc_html__( 'Instagramm link', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert profile link', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Social link', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'yt',
				'type'			   => 'text',
				'title'            => esc_html__( 'YouTube link', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert profile link', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Social link', 'redux-framework-demo' ),
				'default' 		   => ""
			),
...
Redux::set_section(
	...
	array(
		...
		'subsection'	   => true,
		'desc'             => esc_html__( 'Settings for Footer', 'redux-framework-demo' ),
		'customizer_width' => '450px',
		...
		'fields'		   => array(
			array(
				'id'               => 'title_one',
				'type'			   => 'text',
				'title'            => esc_html__( 'GET IN TOUCH title', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert the title', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'GET IN TOUCH', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'title_two',
				'type'			   => 'text',
				'title'            => esc_html__( 'USEFULL LINKS title', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert the title', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'USEFULL LINKS', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'title_three',
				'type'			   => 'text',
				'title'            => esc_html__( 'CAR GALLERY title', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert the title', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'CAR GALLERY', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'title_four',
				'type'			   => 'text',
				'title'            => esc_html__( 'ABOUT title', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert the title', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'ABOUT', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'address',
				'type'			   => 'text',
				'title'            => esc_html__( 'Address', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert the address', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Address', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'phonefooter',
			...
			array(
				'id'               => 'about_footer',
				'type'			   => 'editor',
				'title'            => esc_html__( 'About Footer', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert about section text', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'About Footer', 'redux-framework-demo' ),
				'default' 		   => ""
			),
			array(
				'id'               => 'copyrights',
				'type'			   => 'editor',
				'title'            => esc_html__( 'Copyrights', 'redux-framework-demo' ),
				'subtitle'		   => esc_html__( 'Insert copyrights', 'redux-framework-demo' ),
				'desc'             => esc_html__( 'Copyrights', 'redux-framework-demo' ),
				'default' 		   => ""
			),
		)
	)
